...
class FrutasProductsScreen extends StatefulWidget {
  const FrutasProductsScreen({super.key});

  @override
  State<FrutasProductsScreen> createState() => _FrutasProductsScreenState();
}

class _FrutasProductsScreenState extends State<FrutasProductsScreen> {
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    ...
                    .where('categoria', isEqualTo: 'Frutas')
