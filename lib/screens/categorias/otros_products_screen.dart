...
class OthersProductsScreen extends StatefulWidget {
  const OthersProductsScreen({super.key});

  @override
  State<OthersProductsScreen> createState() => _OthersProductsScreenState();
}

class _OthersProductsScreenState extends State<OthersProductsScreen> {
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    ...
                    .where('categoria', isEqualTo: 'Otros')
