...
class ZapatosProductsScreen extends StatefulWidget {
  const ZapatosProductsScreen({super.key});

  @override
  State<ZapatosProductsScreen> createState() => _ZapatosProductsScreenState();
}

class _ZapatosProductsScreenState extends State<ZapatosProductsScreen> {
